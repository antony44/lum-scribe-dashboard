...
export default function ContextHelpSidebar({ className = "" }: { className?: string }) {
  return (
    <aside className={`w-64 bg-white rounded-xl shadow p-4 border h-fit min-h-[160px] ${className}`}>
      <div className="text-sm font-semibold mb-2">Aucun article ? Proposez d’en commander un.</div>
