...
export default function Index() {
  ...
  return <div className="flex flex-col min-h-screen w-full bg-background text-foreground font-inter">
        ...
        <div className="flex-1 min-w-0">
          ...
          <div className="dark-mode-card rounded-xl border shadow-sm px-6 py-5 mb-6 flex flex-col gap-1">
            ...
            <div className="flex flex-col xs:flex-row gap-3 my-3">
              <StatCard value={ARTICLES_GEN} label="articles générés" tooltip="Nombre total d'articles créés grâce à LÜM." trend="↑96 %" />
            ...
            <Button onClick={handleOrder} disabled={loading} variant="default" className="w-full lg:w-auto mt-4 text-base py-3 bg-[#b91226] text-[#2b395b]">
              {loading ? <span className="flex items-center gap-2">
                  ...
                  Chargement...
                </span> : <>COMMANDER UN NOUVEL ARTICLE</>}
            </Button>
          </div>
        </div>
